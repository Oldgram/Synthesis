...
\textred{Motivation} : achieving a goal frequently requires more than searching
\begin{itemize}
\item \textgreen{Planning} : looking ahead for outcomes of actions
\item \textgreen{Reasoning} : combining evidence to obtain new knowledge
\item \textgreen{Acting} : translation of knowledge into actions
\end{itemize}
...
\subsection{Interpretation and Models}
